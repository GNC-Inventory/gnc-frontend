      ...
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-auto">
        ...
        <div className="p-6" id="receipt-content">
          ...
          <div className="text-center mb-6">
            <div className="w-16 h-16 mx-auto mb-3 relative">
              <Image src="/logo.png" alt="Company Logo" width={64} height={64} className="rounded-full" />
            </div>
            <h3 className="font-bold text-lg mb-1 text-gray-900">GREAT NABUKO</h3>
            <p className="text-gray-600 text-sm">Sales Receipt</p>
          </div>
            ...
            <div className="space-y-2">
              ...
              {transaction.customerAddress && (
                <div>
                  ...
                  <p className="text-gray-900 text-sm">{transaction.customerAddress}</p>
                </div>
              )}
              {transaction.customerPhone && (
                <div>
                  <p className="text-gray-600 text-xs mb-1">Phone</p>
                  <p className="text-gray-900 text-sm">{transaction.customerPhone}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 pt-4 mt-6 text-center">
            ...
            <p className="text-xs text-gray-400">This receipt was generated electronically</p>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 px-6 py-4 bg-gray-50">
          <div className="flex space-x-3">
            ...
            <button
              onClick={onClose}
              className="flex-1 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-50 transition-colors font-medium text-sm"
            >
              Close
            </button>
          </div>
